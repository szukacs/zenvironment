...
import {useGetMyCommunityQuery} from "@/components/mygardenQueries";
...
export default function Community() {
  ...
  return (
    <Page title="Community">
      {myCommunityQuery.status == 'error' && (<>Error, this is definitely not our fault! Drop out your laptop and buy a new
        one! :)</>)}
